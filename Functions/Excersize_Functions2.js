/*
1.Write a function to check whether the `input`
 is a string or not.
...
function isString (a){
    b = 0;
if (typeof parseInt(a) === typeof b){
    return 'it is not a string'
}
 return 'it is a string'
}

console.log(isString('40'))
...
/*
3.Write a function that concatenates
...
/*
4. Write a function to count the number of letter occurrences 
in a string.
...
/*
6.Write a function to find the position of
...
/*
9. Write a function that replaces spaces
 in a string with provided separator.
  If separator is not provided, use “-” (dash) 
...
/*
11. Write a function that converts an array of strings
...
/*
12. Write a function to calculate 
how many years there are left 
until retirement based on the year of birth. 
